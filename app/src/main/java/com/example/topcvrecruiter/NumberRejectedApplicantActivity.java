...
import com.example.topcvrecruiter.Adapter.DashboardRejectedApplicantAdapter;
...
public class NumberRejectedApplicantActivity extends AppCompatActivity {

    private RecyclerView recyclerView;

    private DashboardRejectedApplicantAdapter applicantAdapter;
    ...
    private  void setWidget(){
        ...
        applicantAdapter = new DashboardRejectedApplicantAdapter(applicantDetailLauncher, id_Recruiter, id_User);
